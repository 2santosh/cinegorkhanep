                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="file" name="loan_document" required class="form-control" id="loan_document">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            <label for="deposit_document">Deposit Document</label>
                                            <input type="file" name="deposit_document" required class="form-control" id="deposit_document">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
